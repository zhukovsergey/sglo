<template>
  <div class="container">
  <h1 class="text-center">Новости Лебедянского районного отделения</h1>
...
export default {
  ...
  async asyncData ({ store }) {
    const { data } = await axios.get(
      'https://xn--48-mlcdei8abd3a7g9b.xn--p1ai/api/blog/regions/lebedyan'
    )
    return { data1: data }
  },
  data: () => ({
  ...
  head () {
    return {
      title:
        'Статьи Лебедянского регионального отделения Союза женщин',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content:
            'Актуальные новости и статьи Лебедянского регионального отделения с официального сайта Союза женщин Липецкой области'
        },
