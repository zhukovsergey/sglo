<template>
  <div class="container">
  <h1 class="text-center">Новости Усманского районного отделения</h1>
...
export default {
  ...
  head () {
    return {
      title:
        'Статьи Усманского регионального отделения Союза женщин',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content:
            'Актуальные новости и статьи Усманского регионального отделения с официального сайта Союза женщин Липецкой области'
        },
