...
export default {
  ...
  async asyncData () {
    const { data } = await axios.get(
      'https://xn--48-mlcdei8abd3a7g9b.xn--p1ai/api/blog/ecology'
    )
    return { data1: data }
  },
  data: () => ({
  ...
  head () {
    return {
      title:
        'Статьи на тему "Экология" Союза женщин Липецкой обалсти',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content:
            'Актуальные новости и статьи на тему Экологии с официального сайта Союза женщин Липецкой области'
        },
